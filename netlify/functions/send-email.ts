...
export const handler: Handler = async (event: HandlerEvent, context: HandlerContext) => {
  ...
  try {
    ...
    const smtpUser = process.env.SMTP_USER || "info@finaccoutsourcings.com";
    const smtpPass = process.env.SMTP_PASS || "Ajay@8953";
    const recipientEmail = process.env.RECIPIENT_EMAIL || "info@finaccoutsourcings.com";
